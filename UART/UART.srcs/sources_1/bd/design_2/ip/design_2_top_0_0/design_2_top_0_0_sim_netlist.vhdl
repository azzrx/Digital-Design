...
--               d:/shuzisheji/UART/UART.srcs/sources_1/bd/design_2/ip/design_2_top_0_0/design_2_top_0_0_sim_netlist.vhdl
...
entity design_2_top_0_0_BaudTickGen is
  port (
  ...
  attribute ORIG_REF_NAME of design_2_top_0_0_BaudTickGen : entity is "BaudTickGen";
end design_2_top_0_0_BaudTickGen;

architecture STRUCTURE of design_2_top_0_0_BaudTickGen is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \design_2_top_0_0_BaudTickGen__parameterized0\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \design_2_top_0_0_BaudTickGen__parameterized0\ : entity is "BaudTickGen";
end \design_2_top_0_0_BaudTickGen__parameterized0\;

architecture STRUCTURE of \design_2_top_0_0_BaudTickGen__parameterized0\ is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_2_top_0_0_async_receiver is
  port (
    E : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_2_top_0_0_async_receiver : entity is "async_receiver";
end design_2_top_0_0_async_receiver;

architecture STRUCTURE of design_2_top_0_0_async_receiver is
...
tickgen: entity work.design_2_top_0_0_BaudTickGen
     port map (
      E(0) => \^e\(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_2_top_0_0_async_transmitter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_2_top_0_0_async_transmitter : entity is "async_transmitter";
end design_2_top_0_0_async_transmitter;

architecture STRUCTURE of design_2_top_0_0_async_transmitter is
...
tickgen: entity work.\design_2_top_0_0_BaudTickGen__parameterized0\
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_2_top_0_0_uart_loopback is
  port (
    txd : out STD_LOGIC;
    clk : in STD_LOGIC;
    rxd : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_2_top_0_0_uart_loopback : entity is "uart_loopback";
end design_2_top_0_0_uart_loopback;

architecture STRUCTURE of design_2_top_0_0_uart_loopback is
...
ext_uart_r: entity work.design_2_top_0_0_async_receiver
     port map (
      E(0) => RxD_data_ready,
...
ext_uart_t: entity work.design_2_top_0_0_async_transmitter
     port map (
      E(0) => RxD_data_ready,
...
begin
U0: entity work.design_2_top_0_0_uart_loopback
     port map (
      clk => clk,
      rxd => rxd,
      txd => txd
...
entity design_2_top_0_0 is
  ...
  attribute X_CORE_INFO of design_2_top_0_0 : entity is "top,Vivado 2018.3";
